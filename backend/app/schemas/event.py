...
class EventBase(BaseModel):
    ...
    poster_image_url: Optional[str] = Field(None, max_length=1024, description="URL de l'affiche officielle de l'événement")
...
class EventUpdate(BaseModel):
    ...
    poster_image_url: Optional[str] = Field(None, max_length=1024)
